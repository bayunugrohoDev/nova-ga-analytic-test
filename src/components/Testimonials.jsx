...
const TESTIMONIAL_PERSONS = [
  ...
  },
  {
    avatar: rikkeImage,
    name: "Rikke Klas",
    testimonial: `"I've been using this travel app for a while now, and it's become an essential tool for all my trips. The app's great features, such as the ability to create custom lists and receive personalized recommendations, have made my travel experiences so much better. The usability is fantastic, and the networking feature is a game-changer! I've met so many amazing people and gotten insider tips that have made my trips unforgettable"`,
  },
];
